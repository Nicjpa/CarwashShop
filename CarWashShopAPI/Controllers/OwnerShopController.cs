...
namespace CarWashShopAPI.Controllers
{
    ...
    public class OwnerShopController : ControllerBase
    {
        ...
        public async Task<ActionResult<CarWashShopView>> Post([FromBody] CarWashShopCreation shopCreation)
        {
            ...
            if (await _carWashShopRepository.CheckShopName(shopCreation.Name))
            {
        ...
        public async Task<ActionResult<CarWashShopView>> Put([FromBody] CarWashShopUpdate shopUpdate)
        {
            ...
            if (await _carWashShopRepository.CheckShopName(shopUpdate.Name))
            {
            ...
            if (carWashShopEntity == null)
            {
                ...
                return NotFound($"You don't have any CarWashShop with ID: '{shopUpdate.Id}'..");
            }
        ...
        public async Task<ActionResult<string>> Delete([FromBody] CarWashShopRemovalRequestCreation statementCreation)
         {
            ...
            if (isRequestMadeAlready)
            {
                ...
                return BadRequest($"Removal request is already made for the CarWashShop with ID: '{statementCreation.ShopId}'");
            }
            ...
            if (carWashShop == null)
            {
                ...
                return BadRequest($"There is no CarWashShop with ID: '{statementCreation.ShopId}' in your possession..");
            }
            ...
            if (amountOfOwners > 1)
            {
                ...
                await _carWashShopRepository.AddRangeOfShopRemovals(ShopRemovalRequestList);
                await _carWashShopRepository.Commit();
