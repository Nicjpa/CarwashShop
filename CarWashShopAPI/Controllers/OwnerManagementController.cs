...
namespace CarWashShopAPI.Controllers
{
    ...
    public class OwnerManagementController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<DisbandRequestView>>> GetAllDisbandRequests([FromQuery] OwnerRequestsFilters filters)
        {
            ...
            var disbandRequestsPaginated = await _ownerRepository.Pagination(HttpContext, allDisbandRequestsEntities, filters.RecordsPerPage, new PaginationDTO { Page = filters.Page, RecordsPerPage = filters.RecordsPerPage});
        ...
        public async Task<ActionResult<List<ShopRemovalRequestView>>> GetShopRemovalRequests([FromQuery] OwnerRequestsFilters filters)
        {
            ...
            var removalRequestsPaginated = await _ownerRepository.Pagination(HttpContext, allShopRemovalRequestsEntities, filters.RecordsPerPage, new PaginationDTO { Page = filters.Page, RecordsPerPage = filters.RecordsPerPage });
        ...
        public async Task<ActionResult<string>> AddNewCoOwnerToShop([FromBody] CarWashShopOwnerAdd newOwners)
        {
            ...
            if (carWashShop == null)
            {
                ...
                return NotFound($"CarWashShop with ID: '{newOwners.ShopId}' doesn't exist..");
            }
        ...
        public async Task<ActionResult<string>> RequestOwnerRemoval([FromBody] DisbandRequestCreation ownerRemovalRequest)
        {
            ...
            if (carWashShop == null)
            {
                ...
                return BadRequest($"Owner name '{ownerNameToRemove}' doesn't match with the CarWashShop ID: '{ownerRemovalRequest.ShopId}'..");
            }
            else
            {
        ...
        public async Task<ActionResult<string>> ApproveDisbandFromShop(int shopID)
        {
            ...
            await _ownerRepository.UpdateEntity(ownerRemovalRequest);
            await _ownerRepository.Commit();
        ...
        public async Task<ActionResult<string>> CancelShopRemovalRequest(int shopID)
        {
            ...
            await _ownerRepository.CancelShopRemovalReq(cwShopRemovalRequests);
            await _ownerRepository.Commit();
